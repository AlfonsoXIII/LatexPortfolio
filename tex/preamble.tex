...
\usetikzlibrary{patterns, angles, quotes, arrows.meta, decorations.markings}
\usepackage{pgfplots}
...
\newcounter{temas}
\setcounter{temas}{1}
\newcommand{\tema}[1]{{\noindent\Large \textbf{TEMA \Roman{temas}.} }\\\noindent{\Huge\textbf{\MakeUppercase{#1}}}\addcontentsline{toc}{section}{{\footnotesize TEMA \Roman{temas}} \makefirstuc{#1}}\addtocounter{temas}{1}\bigbreak}

\newcommand{\seccion}[1]{{\Large\noindent\textbf{#1}\addcontentsline{toc}{subsection}{#1}}}
\newcommand{\apartado}[1]{{\large\noindent\textbf{#1}\addcontentsline{toc}{subsubsection}{#1}}}